...
TUNNEL_NAME="peerjs"
HTTP_SERVICE_URL="http://localhost:9000"
HOSTNAME="$HOST_DOMAIN"
CREDENTIALS_DIR=~/.cloudflared/peerjs
...
echo -e "${YELLOW}Starting Cloudflare Tunnel Setup for PeerJS...${NC}"
...
echo -e "${YELLOW}Your PeerJS server is now accessible at: https://$HOSTNAME${NC}"
